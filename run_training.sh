...
# RAG-Anything Training UI Startup Script
# This script ensures proper environment setup and runs the Gradio UI

echo "=========================================="
echo "Starting RAG-Anything Training UI"
echo "=========================================="
...
if pgrep -f "run_training.py" > /dev/null; then
    echo "Found existing Training UI process. Killing it..."
...
echo "=========================================="
echo "Access the UI at: http://localhost:7862"
